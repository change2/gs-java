Strophe.addConnectionPlugin("pubsub", {
  _connection: null, init: function (conn) {
    ...
    iq.c("pubsub", {xmlns: Strophe.NS.PUBSUB}).c("create", {node: node}).up().cnode(c_options);
    ...
    var publish_elem = Strophe.xmlElement("publish", [["node", node], ["jid", jid]]);
    for (var i in items) {
